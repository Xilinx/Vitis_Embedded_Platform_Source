...
int main(int argc, char *argv[])
{
    ...
    cl::Kernel krnl_cnt_to_mig(program, "krnl_cnt_to_mig");
    ...
    int narg = 0;
    krnl_cnt_to_mig.setArg(narg++, buffer_b);
    krnl_cnt_to_mig.setArg(narg++, DATA_SIZE);
    narg = 0;
    ...
    //Launch the Kernel
    std::cout << "Processing: 'q.enqueueTask(krnl_vector_add);"
              << "'\n";
    q.enqueueTask(krnl_cnt_to_mig);
