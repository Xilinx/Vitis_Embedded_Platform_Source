...
#
# 2019.1_proj.tcl: Tcl script for re-creating project 'zcu102_pl_ddr_stream'
#
# Generated by Vivado on Sat Apr 13 14:47:20 PDT 2019
# IP Build 2511063 on Fri Apr 12 06:44:46 MDT 2019
#
...
#
# 1. This project restoration tcl script (2019.1_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/opt/robarm/Projects/SDx_Platforms/dev/zcu102_pl_ddr_stream/vivado/zcu102_pl_ddr_stream/zcu102_pl_ddr_stream.srcs/sources_1/imports/hdl/zcu102_pl_ddr_wrapper.v"
#    "/opt/robarm/Projects/SDx_Platforms/dev/zcu102_pl_ddr_stream/vivado/zcu102_pl_ddr_stream/zcu102_pl_ddr_stream.srcs/constrs_1/imports/constraints/constraints.xdc"
#
...
set _xil_proj_name_ "zcu102_pl_ddr_stream"
...
set orig_proj_dir "[file normalize "$origin_dir/zcu102_pl_ddr_stream"]"

# Create project
create_project ${_xil_proj_name_} ./vivado/${_xil_proj_name_} -part xczu9eg-ffvb1156-2-e
...
set files [list \
               "[file normalize "$origin_dir/hdl/zcu102_pl_ddr_wrapper.v"]"\
              ]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zcu102_pl_ddr_wrapper" -objects $obj
...
# Proc to create BD zcu102_pl_ddr
proc cr_bd_zcu102_pl_ddr { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zcu102_pl_ddr
...
"
  ...
  set mig_ref_clk [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 mig_ref_clk ]
  ...
  # Create ports
  set ddr_calibration_complete [ create_bd_port -dir O ddr_calibration_complete ]
  ...
  # Create instance: counter_fifo, and set properties
  set counter_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo counter_fifo ]
  set_property -dict [ list \
  ...
  set irq_concat_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat irq_concat_0 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {1} \
 ] $irq_concat_0

  # Create instance: irq_concat_1, and set properties
  set irq_concat_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat irq_concat_1 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {1} \
 ] $irq_concat_1

  # Create instance: psr_clk_300, and set properties
  set psr_clk_300 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset psr_clk_300 ]

  # Create instance: psr_clk_600, and set properties
  set psr_clk_600 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset psr_clk_600 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#UART 1#UART 1#GPIO0 MIO#GPIO0 MIO#CAN 1#CAN 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {159.984009} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {5} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {100} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__SRCSEL {RPLL} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {99.990005} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR0 {12} \
  ...
  connect_bd_intf_net -intf_net C0_SYS_CLK_1 [get_bd_intf_ports mig_ref_clk] [get_bd_intf_pins ddr4_0/C0_SYS_CLK]
  ...
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins counter_fifo/s_axis_tdata]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins psr_clk_600/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins psr_clk_300/dcm_locked] [get_bd_pins psr_clk_600/dcm_locked]
  connect_bd_net -net constant_vcc_dout [get_bd_pins constant_1/dout] [get_bd_pins counter_fifo/s_axis_aresetn] [get_bd_pins counter_fifo/s_axis_tvalid]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins counter_fifo/m_axis_aclk] [get_bd_pins psr_clk_300/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk1 [get_bd_pins axi_smc/aclk1] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ddr4_0/c0_ddr4_ui_clk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins clk_wiz_0/reset] [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins psr_clk_300/ext_reset_in] [get_bd_pins psr_clk_600/ext_reset_in]
  connect_bd_net -net ddr4_0_c0_init_calib_complete [get_bd_ports ddr_calibration_complete] [get_bd_pins ddr4_0/c0_init_calib_complete]
  connect_bd_net -net irq_concat_0_dout [get_bd_pins irq_concat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net irq_concat_1_dout [get_bd_pins irq_concat_1/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq1]
  connect_bd_net -net rst_ddr4_0_300M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins psr_clk_300/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins ddr4_0/sys_rst] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins counter_fifo/s_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
...
#  -string -flagsOSRD
preplace port ddr4_sdram -pg 1 -lvl 5 -x 1670 -y 480 -defaultsOSRD
preplace port mig_ref_clk -pg 1 -lvl 0 -x 0 -y 500 -defaultsOSRD
preplace port ddr_calibration_complete -pg 1 -lvl 5 -x 1670 -y 500 -defaultsOSRD
preplace inst psr_100 -pg 1 -lvl 3 -x 1070 -y 880 -defaultsOSRD
preplace inst psr_160 -pg 1 -lvl 3 -x 1070 -y 1060 -defaultsOSRD
preplace inst psr_200 -pg 1 -lvl 3 -x 1070 -y 310 -defaultsOSRD
preplace inst rst_ddr4_0_300M -pg 1 -lvl 2 -x 540 -y 600 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 3 -x 1070 -y 1200 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 1070 -y 620 -defaultsOSRD
preplace inst c_counter_binary_0 -pg 1 -lvl 3 -x 1070 -y 50 -defaultsOSRD
preplace inst constant_1 -pg 1 -lvl 3 -x 1070 -y 150 -defaultsOSRD
preplace inst counter_fifo -pg 1 -lvl 4 -x 1450 -y 180 -defaultsOSRD
preplace inst ddr4_0 -pg 1 -lvl 4 -x 1450 -y 530 -defaultsOSRD
preplace inst irq_concat_0 -pg 1 -lvl 1 -x 120 -y 720 -defaultsOSRD
preplace inst irq_concat_1 -pg 1 -lvl 1 -x 120 -y 820 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 540 -y 800 -defaultsOSRD
preplace netloc c_counter_binary_0_Q 1 3 1 1260J 50n
preplace netloc constant_vcc_dout 1 3 1 1250 150n
preplace netloc ddr4_0_c0_ddr4_ui_clk 1 1 4 230 490 870 490 1260 420 1640
preplace netloc ddr4_0_c0_ddr4_ui_clk_sync_rst 1 1 4 220 410 NJ 410 NJ 410 1650
preplace netloc ddr4_0_c0_init_calib_complete 1 4 1 NJ 500
preplace netloc irq_concat_0_dout 1 1 1 220J 720n
preplace netloc irq_concat_1_dout 1 1 1 NJ 820
preplace netloc rst_ddr4_0_300M_peripheral_aresetn 1 2 2 890 540 N
preplace netloc util_vector_logic_0_Res 1 3 1 1260 560n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 2 2 850 210 NJ
preplace netloc zynq_ultra_ps_e_0_pl_clk1 1 2 1 860 820n
preplace netloc zynq_ultra_ps_e_0_pl_clk2 1 2 1 N 840
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 1 880 290n
preplace netloc C0_SYS_CLK_1 1 0 4 NJ 500 NJ 500 NJ 500 NJ
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 2 1 860 600n
preplace netloc ddr4_0_C0_DDR4 1 4 1 NJ 480
preplace netloc axi_smc_M00_AXI 1 3 1 1250 520n
levelinfo -pg 1 0 120 540 1070 1450 1670
pagesize -pg 1 -db -bbox -sgen -130 -10 1900 1260
"
}
  ...
  set_property PFM_NAME {xilinx.com:board:zcu102_pl_ddr_stream:1.0} [get_files [current_bd_design].bd]
...
# End of cr_bd_zcu102_pl_ddr()
cr_bd_zcu102_pl_ddr ""
set_property PFM_NAME "xilinx.com:board:zcu102_pl_ddr_stream:1.0" [get_files zcu102_pl_ddr.bd ]
set_property REGISTERED_WITH_MANAGER "1" [get_files zcu102_pl_ddr.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zcu102_pl_ddr.bd ]

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu9eg-ffvb1156-2-e -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu9eg-ffvb1156-2-e -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
