...
platform -name $platform_name -desc "Basic platform targeting the zc702 board, which includes 1GB of DDR3, 16MB Quad-SPI Flash and an SDIO card interface. More information at https://www.xilinx.com/products/boards-and-kits/ek-z7-zc702-g.html" -hw $xsa_path/$platform_name.xsa -out ./$OUTPUT
