...
if { $list_projs eq "" } {
   create_project zc706_base ./zc706_base_vivado -part xc7z045ffg900-2 -force
...
proc create_root_design { parentCell } {
  ...
  set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps7]
  ...
  set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps7_axi_periph]
  ...
  set_property PFM_NAME {xilinx:zc706:xilinx_zc706_base_202010_1:1.0} [get_files [current_bd_design].bd]
...
write_hw_platform -force -unified -include_bit ./xilinx_zc706_base_202010_1.xsa
