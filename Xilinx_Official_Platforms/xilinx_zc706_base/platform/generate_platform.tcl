...
platform -name $platform_name -desc "A basic static platform targeting the ZC706 evaluation board, which includes 1GB DDR3, GEM, USB, SDIO interface and UART of the Processing System. It reserves most of the PL resources for user to add acceleration kernels" {*}$plat_arg -out $platform_out
