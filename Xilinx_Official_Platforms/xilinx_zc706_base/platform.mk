...
PREBUILT_LINUX_PATH ?= /opt/xilinx/platform/xilinx-zynq-common-v2022.1
ifneq ($(wildcard $(TOP_DIR)/xilinx-zynq-common-v2022.1),)
PREBUILT_LINUX_PATH ?= $(TOP_DIR)/xilinx-zynq-common-v2022.1
endif
