...
################################################################
# This is a generated script based on design: zcu104_dpu
#
...
if { $list_projs eq "" } {
   create_project zcu104_dpu zcu104_dpu -part xczu7ev-ffvc1156-2-e
...
set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps_e]
  ...
  set_property PFM_NAME {xilinx:zcu104:zcu104_dpu:1.0} [get_files [current_bd_design].bd]
...
generate_target  all  [get_files  ./zcu104_dpu/zcu104_dpu.srcs/sources_1/bd/zcu104_dpu/zcu104_dpu.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu104_dpu/zcu104_dpu.srcs/sources_1/bd/zcu104_dpu/zcu104_dpu.bd] -top
add_files -norecurse ./zcu104_dpu/zcu104_dpu.srcs/sources_1/bd/zcu104_dpu/hdl/zcu104_dpu_wrapper.v
...
file mkdir ./zcu104_dpu/zcu104_dpu.sdk
write_hwdef -force  -file ./zcu104_dpu/zcu104_dpu.sdk/zcu104_dpu_wrapper.hdf

set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

write_hw_platform -unified -include_bit ./zcu104_dpu.xsa
#write_hw_platform -force  ./zcu104_dpu.xsa

validate_hw_platform ./zcu104_dpu.xsa
