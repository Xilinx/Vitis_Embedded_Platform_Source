...
platform -name $platform_name -desc "A reVISION platform targeting the ZCU104 evaluation board, which includes 2GB of DDR4 for the Processing System, video codec unit supports H.264/H.265, optimized to work with reVISION development environment. This platform shows the capabilities of the DPU machine learning IP along with the VCU decoder. More information at https://www.xilinx.com/products/boards-and-kits/zcu104.html" -hw $xsa_path/$platform_name.xsa -out ./$OUTPUT
