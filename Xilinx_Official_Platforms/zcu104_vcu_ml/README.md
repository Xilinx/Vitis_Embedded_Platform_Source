# Vitis VCU+ML demo Platform for the zcu104 Board

This demo design platform is useful to demonstrate the Xilinx Video Codec Unit (VCU) IP along with
the Machine learning (ML) using the Xilinx Deep Learning Processor Unit (DPU) IP as an Vitis kernel.
...
Note that by default this Makefile will install the platform to "platform_repo/zcu104_vcu_ml/export/zcu104_vcu_ml/"
...
Build a platform without modifying hardware:
	...
	example:
		make petalinux_proj XSA_DIR=/home/user/zcu104_vcu_ml/vivado
		make pfm /home/user/zcu104_vcu_ml/vivado
...
The boot script at zcu104_vcu_ml/scripts/UENV.TXT is mandatory to be copied to SD card before booting
...
Xilinx_Official_Platforms/zcu104_vcu_ml/petalinux/project-spec/meta-user/recipes-xrt/xrt/xrt_git.bb
Xilinx_Official_Platforms/zcu104_vcu_ml/petalinux/project-spec/meta-user/recipes-xrt/zocl/zocl_git.bb
