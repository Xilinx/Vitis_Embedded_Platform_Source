...
################################################################
# This is a generated script based on design: zcu102_dpu
#
...
if { $list_projs eq "" } {
   create_project zcu102_dpu zcu102_dpu -part xczu9eg-ffvb1156-2-e
...
proc create_root_design { parentCell } {
 ...
 set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps_e]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins interconnect_axifull/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_LPD]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins interconnect_axifull/ACLK] [get_bd_pins interconnect_axifull/M00_ACLK] [get_bd_pins interconnect_axifull/S00_ACLK] [get_bd_pins interconnect_axihpm0fpd/ACLK] [get_bd_pins interconnect_axihpm0fpd/M00_ACLK] [get_bd_pins interconnect_axihpm0fpd/S00_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxi_lpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs ps_e/SAXIGP6/LPD_DDR_LOW] -force
  ...
  set_property PFM_NAME {xilinx:zcu102:zcu102_dpu:1.0} [get_files [current_bd_design].bd]
...
set_property PFM.AXI_PORT $lpdVal [get_bd_cells /interconnect_axifull]
...
generate_target  all  [get_files  ./zcu102_dpu/zcu102_dpu.srcs/sources_1/bd/zcu102_dpu/zcu102_dpu.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu102_dpu/zcu102_dpu.srcs/sources_1/bd/zcu102_dpu/zcu102_dpu.bd] -top
add_files -norecurse ./zcu102_dpu/zcu102_dpu.srcs/sources_1/bd/zcu102_dpu/hdl/zcu102_dpu_wrapper.v
...
file mkdir ./zcu102_dpu/zcu102_dpu.sdk
write_hwdef -force  -file ./zcu102_dpu/zcu102_dpu.sdk/zcu102_dpu_wrapper.hdf
#file copy -force ./zcu102_dpu/zcu102_dpu.runs/impl_1/zcu102_wrapper.sysdef ./zcu102_dpu/zcu102_dpu.sdk/zcu102_wrapper.hdf

set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

write_hw_platform -unified -include_bit ./zcu102_dpu.xsa
#write_hw_platform -force ./zcu102_dpu.xsa
validate_hw_platform ./zcu102_dpu.xsa
