...
Note that by default this Makefile will install the platform to "platform_repo/zcu102_dpu/export/zcu102_dpu/"
...
petlainux sources to generate the image.ub, rootfs.tar.gz and platform sources to generate the Vitis platform.
...
Build a platform without modifying hardware:
	...
	example:
		make petalinux_proj XSA_DIR=/home/user/zcu102_dpu/vivado
		make pfm /home/user/zcu102_dpu/vivado
