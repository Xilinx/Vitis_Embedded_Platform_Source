...
# Generate simulation top for your entire design which would include aggregated NOC in the form of xlnoc.bd
# <BS> # uncomment below if noc switch network is not generated verify 

#generate_switch_network_for_noc  
update_compile_order -fileset sim_1

#Generate the simulation script which will compile the <syn_top>_sim_wrapper and xlnoc.bd modules also
