...
################################################################
# This is a generated script based on design: zcu104_smart_camera
#
...
# source zcu104_smart_camera_script.tcl
...
if { $list_projs eq "" } {
   create_project zcu104_smart_camera zcu104_smart_camera -part xczu7ev-ffvc1156-2-e
...
set design_name zcu104_smart_camera
...
proc create_hier_cell_mipi_csi2_rx { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type intr isp_intr
  ...
  set frmbuf_wr_rst_gpio_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice frmbuf_wr_rst_gpio_1 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {95} \
  ...
  set v_proc_ss_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_proc_ss v_proc_ss_1 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_ctrl2] [get_bd_intf_pins v_proc_ss_0/s_axi_ctrl]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins s_axi_CTRL3] [get_bd_intf_pins v_gamma_lut_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins s_axi_mipi_frm_wr] [get_bd_intf_pins v_frmbuf_wr_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins s_axi_CTRL] [get_bd_intf_pins v_frmbuf_wr_1/s_axi_CTRL]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins s_axi_ctrl1] [get_bd_intf_pins v_proc_ss_1/s_axi_ctrl]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins M_AXI] [get_bd_intf_pins axi_data_fifo_1/M_AXI]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_1_M_AXIS [get_bd_intf_pins axis_register_slice_1/M_AXIS] [get_bd_intf_pins v_proc_ss_1/s_axis]
  ...
  connect_bd_intf_net -intf_net s_axi_gamma_lut_1 [get_bd_intf_pins s_axi_gamma_lut] [get_bd_intf_pins v_demosaic_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net v_proc_ss_csc_1_m_axis [get_bd_intf_pins v_frmbuf_wr_1/s_axis_video] [get_bd_intf_pins v_proc_ss_1/m_axis]

  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins frmbuf_wr_rst_gpio/Din] [get_bd_pins frmbuf_wr_rst_gpio_1/Din] [get_bd_pins sensor_rst_gpio/Din] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din]
  connect_bd_net -net M06_ARESETN_1 [get_bd_pins video_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_subset_converter_0/aresetn]
  connect_bd_net -net Net [get_bd_pins axi_data_fifo_1/aresetn] [get_bd_pins frmbuf_wr_rst_gpio_1/Dout] [get_bd_pins v_frmbuf_wr_1/ap_rst_n]
  ...
  connect_bd_net -net clk_150mhz [get_bd_pins m_axi_s2mm_aclk] [get_bd_pins axi_data_fifo_0/aclk] [get_bd_pins axi_data_fifo_1/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins mipi_csi2_rx_subsystem_0/video_aclk] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins v_frmbuf_wr_1/ap_clk] [get_bd_pins v_gamma_lut_0/ap_clk] [get_bd_pins v_proc_ss_0/aclk] [get_bd_pins v_proc_ss_1/aclk_axis] [get_bd_pins v_proc_ss_1/aclk_ctrl]
  ...
  connect_bd_net -net v_demosaic_0_interrupt [get_bd_pins isp_intr] [get_bd_pins v_demosaic_0/interrupt]
  ...
  connect_bd_net -net v_frmbuf_wr_1_interrupt [get_bd_pins interrupt] [get_bd_pins v_frmbuf_wr_1/interrupt]
  connect_bd_net -net v_gamma_lut_0_interrupt [get_bd_pins interrupt1] [get_bd_pins v_gamma_lut_0/interrupt]
  connect_bd_net -net v_proc_ss_csc_1_s_axis_tready [get_bd_pins util_vector_logic_0/Op2] [get_bd_pins v_proc_ss_1/s_axis_tready]
  connect_bd_net -net vcc_dout [get_bd_pins dout1] [get_bd_pins vcc/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins v_proc_ss_1/aresetn_ctrl] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins v_gamma_lut_0/ap_rst_n] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins v_proc_ss_0/aresetn] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins mipi_csi2_rx_subsystem_0/video_aresetn] [get_bd_pins xlslice_4/Dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: buf_100MHz, and set properties
  set buf_100MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf buf_100MHz ]
  set_property -dict [ list \
   CONFIG.C_BUFGCE_DIV {6} \
   CONFIG.C_BUF_TYPE {BUFGCE_DIV} \
 ] $buf_100MHz

  # Create instance: buf_300MHz, and set properties
  set buf_300MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf buf_300MHz ]
  set_property -dict [ list \
   CONFIG.C_BUFGCE_DIV {2} \
   CONFIG.C_BUF_TYPE {BUFGCE_DIV} \
 ] $buf_300MHz

  # Create instance: buf_600MHz, and set properties
  set buf_600MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf buf_600MHz ]
  set_property -dict [ list \
   CONFIG.C_BUF_TYPE {BUFGCE_DIV} \
 ] $buf_600MHz
  ...
  # Create instance: vpss_rst_gpio, and set properties
  set vpss_rst_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice vpss_rst_gpio ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {5} \
   CONFIG.DIN_TO {5} \
   CONFIG.DIN_WIDTH {95} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {300.000006} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_interconnect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_interconnect_4/S01_AXI] [get_bd_intf_pins mipi_csi2_rx/M_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins v_multi_scaler_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net axi_interconnect_2_M06_AXI [get_bd_intf_pins axi_interconnect_2/M06_AXI] [get_bd_intf_pins mipi_csi2_rx/s_axi_CTRL3]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_4_M00_AXI [get_bd_intf_pins axi_interconnect_4/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net axi_interconnect_M00_AXI [get_bd_intf_pins axi_interconnect/M00_AXI] [get_bd_intf_pins vcu_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_M02_AXI [get_bd_intf_pins axi_interconnect/M02_AXI] [get_bd_intf_pins sensor_iic_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M03_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins axi_interconnect/M03_AXI]
  connect_bd_intf_net -intf_net csirxss_s_axi_1 [get_bd_intf_pins axi_interconnect/M01_AXI] [get_bd_intf_pins mipi_csi2_rx/csirxss_s_axi]
  connect_bd_intf_net -intf_net mipi_csi2_rx_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_4/S00_AXI] [get_bd_intf_pins mipi_csi2_rx/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net s_axi_CTRL_1 [get_bd_intf_pins axi_interconnect_2/M03_AXI] [get_bd_intf_pins mipi_csi2_rx/s_axi_CTRL]
  connect_bd_intf_net -intf_net s_axi_ctrl1_1 [get_bd_intf_pins axi_interconnect_2/M04_AXI] [get_bd_intf_pins mipi_csi2_rx/s_axi_ctrl1]
  connect_bd_intf_net -intf_net s_axi_ctrl2_1 [get_bd_intf_pins axi_interconnect_2/M01_AXI] [get_bd_intf_pins mipi_csi2_rx/s_axi_ctrl2]
  connect_bd_intf_net -intf_net s_axi_gamma_lut_1 [get_bd_intf_pins axi_interconnect_2/M05_AXI] [get_bd_intf_pins mipi_csi2_rx/s_axi_gamma_lut]
  connect_bd_intf_net -intf_net s_axi_mipi_frm_wr_1 [get_bd_intf_pins axi_interconnect_2/M02_AXI] [get_bd_intf_pins mipi_csi2_rx/s_axi_mipi_frm_wr]
  connect_bd_intf_net -intf_net sensor_iic_0_IIC [get_bd_intf_ports sensor_iic] [get_bd_intf_pins sensor_iic_0/IIC]
  connect_bd_intf_net -intf_net v_multi_scaler_0_m_axi_mm_video [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins v_multi_scaler_0/m_axi_mm_video]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net Net [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/M01_ACLK] [get_bd_pins axi_interconnect_2/M02_ACLK] [get_bd_pins axi_interconnect_2/M03_ACLK] [get_bd_pins axi_interconnect_2/M04_ACLK] [get_bd_pins axi_interconnect_2/M05_ACLK] [get_bd_pins axi_interconnect_2/M06_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins axi_interconnect_4/S01_ACLK] [get_bd_pins buf_300MHz/BUFGCE_O] [get_bd_pins mipi_csi2_rx/m_axi_s2mm_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins v_multi_scaler_0/ap_clk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc1_fpd_aclk]
  connect_bd_net -net aresetn_100M [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins mipi_csi2_rx/lite_aresetn_0] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins sensor_iic_0/s_axi_aresetn]
  ...
  connect_bd_net -net buf_600MHz_BUFGCE_O [get_bd_pins buf_600MHz/BUFGCE_O] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins vcu_0/pll_ref_clk]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins buf_100MHz/BUFGCE_I] [get_bd_pins buf_300MHz/BUFGCE_I] [get_bd_pins buf_600MHz/BUFGCE_I] [get_bd_pins clk_wiz_1/clk_out2]
  connect_bd_net -net clk_wiz_1_clk_out5 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins buf_100MHz/BUFGCE_O] [get_bd_pins mipi_csi2_rx/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins sensor_iic_0/s_axi_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins proc_sys_reset_2/dcm_locked]
  connect_bd_net -net dphy_clk_200M_1 [get_bd_pins clk_wiz_1/clk_out3] [get_bd_pins mipi_csi2_rx/dphy_clk_200M]
  connect_bd_net -net gpio [get_bd_pins mipi_csi2_rx/Din] [get_bd_pins vpss_rst_gpio/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
  connect_bd_net -net interrupt_concat_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins interrupt_concat/dout]
  connect_bd_net -net interrupts_dout [get_bd_pins interrupts/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq1]
  connect_bd_net -net mipi_csi2_rx_Dout [get_bd_ports sensor_gpio_rst] [get_bd_pins mipi_csi2_rx/Dout]
  connect_bd_net -net mipi_csi2_rx_csirxss_csi_irq [get_bd_pins interrupts/In2] [get_bd_pins mipi_csi2_rx/csirxss_csi_irq]
  ...
  connect_bd_net -net mipi_csi2_rx_interrupt [get_bd_pins interrupts/In4] [get_bd_pins mipi_csi2_rx/interrupt]
  connect_bd_net -net mipi_csi2_rx_interrupt1 [get_bd_pins interrupts/In7] [get_bd_pins mipi_csi2_rx/interrupt1]
  connect_bd_net -net mipi_csi2_rx_isp_intr [get_bd_pins interrupts/In6] [get_bd_pins mipi_csi2_rx/isp_intr]
  connect_bd_net -net mipi_csi2_rx_s2mm_introut [get_bd_pins interrupts/In1] [get_bd_pins mipi_csi2_rx/s2mm_introut]
  connect_bd_net -net mpsoc_ss_pl_resetn0_0 [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins vcu_0/vcu_resetn] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/M01_ARESETN] [get_bd_pins axi_interconnect_2/M02_ARESETN] [get_bd_pins axi_interconnect_2/M03_ARESETN] [get_bd_pins axi_interconnect_2/M04_ARESETN] [get_bd_pins axi_interconnect_2/M05_ARESETN] [get_bd_pins axi_interconnect_2/M06_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins mipi_csi2_rx/video_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net sensor_iic_0_iic2intc_irpt [get_bd_pins interrupts/In0] [get_bd_pins sensor_iic_0/iic2intc_irpt]
  connect_bd_net -net v_multi_scaler_0_interrupt [get_bd_pins interrupts/In5] [get_bd_pins v_multi_scaler_0/interrupt]
  connect_bd_net -net vcu_0_vcu_host_interrupt [get_bd_pins interrupts/In3] [get_bd_pins vcu_0/vcu_host_interrupt]
  connect_bd_net -net vpss_rst_gpio_Dout [get_bd_pins v_multi_scaler_0/ap_rst_n] [get_bd_pins vpss_rst_gpio/Dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins buf_100MHz/BUFGCE_CE] [get_bd_pins buf_300MHz/BUFGCE_CE] [get_bd_pins buf_600MHz/BUFGCE_CE] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces v_multi_scaler_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC1_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces v_multi_scaler_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_QSPI] SEG_zynq_ultra_ps_e_0_HPC1_QSPI
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xB0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] SEG_axi_intc_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/mipi_csi2_rx_subsystem_0/csirxss_s_axi/Reg] SEG_mipi_csi2_rx_subsystem_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xB0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sensor_iic_0/S_AXI/Reg] SEG_sensor_iic_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA2010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_demosaic_0/s_axi_CTRL/Reg] SEG_v_demosaic_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA2020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_frmbuf_wr_0/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA2030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_frmbuf_wr_1/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA2080000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_gamma_lut_0/s_axi_CTRL/Reg] SEG_v_gamma_lut_0_Reg
  create_bd_addr_seg -range 0x00020000 -offset 0xA20A0000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_multi_scaler_0/s_axi_CTRL/Reg] SEG_v_multi_scaler_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA2000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_proc_ss_0/s_axi_ctrl/Reg] SEG_v_proc_ss_0_Reg
  create_bd_addr_seg -range 0x00040000 -offset 0xA2040000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_proc_ss_1/s_axi_ctrl/Reg] SEG_v_proc_ss_1_Reg
  create_bd_addr_seg -range 0x00100000 -offset 0xB0100000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs vcu_0/S_AXI_LITE/Reg] SEG_vcu_0_Reg
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces mipi_csi2_rx/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces mipi_csi2_rx/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces mipi_csi2_rx/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces mipi_csi2_rx/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces mipi_csi2_rx/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs mipi_csi2_rx/v_frmbuf_wr_0/Data_m_axi_mm_video/SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces mipi_csi2_rx/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs mipi_csi2_rx/v_frmbuf_wr_1/Data_m_axi_mm_video/SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces v_multi_scaler_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs v_multi_scaler_0/Data_m_axi_mm_video/SEG_zynq_ultra_ps_e_0_HPC1_LPS_OCM]
...
add_files -fileset constrs_1 -norecurse ./vcu_trd.xdc
import_files -fileset constrs_1 ./vcu_trd.xdc

generate_target  all  [get_files ./zcu104_smart_camera/zcu104_smart_camera.srcs/sources_1/bd/zcu104_smart_camera/zcu104_smart_camera.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu104_smart_camera/zcu104_smart_camera.srcs/sources_1/bd/zcu104_smart_camera/zcu104_smart_camera.bd] -top
add_files -norecurse ./zcu104_smart_camera/zcu104_smart_camera.srcs/sources_1/bd/zcu104_smart_camera/hdl/zcu104_smart_camera_wrapper.v
...
file mkdir ./zcu104_smart_camera/zcu104_smart_camera.sdk
write_hwdef -force  -file ./zcu104_smart_camera/zcu104_smart_camera.sdk/zcu104_smart_camera_wrapper.hdf

set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

write_hw_platform -unified -include_bit ./zcu104_smart_camera.xsa
validate_hw_platform ./zcu104_smart_camera.xsa
puts "List of IPs in the system are\n"
set all_ips [get_bd_cells -hier *] 
foreach ip $all_ips { puts "VLNV: [get_property VLNV $ip]" }
 puts "END List of IPs in the system are\n" 
