...
DTSI_FILES       = $(TOP_DIR)/user_dts/system-user.dtsi
...
#flow related
PREBUILT_LINUX_PATH ?= /opt/xilinx/platform/xilinx-zynqmp-common-v2026.1
ifneq ($(wildcard $(TOP_DIR)/xilinx-zynqmp-common-v2026.1),)
PREBUILT_LINUX_PATH ?= $(TOP_DIR)/xilinx-zynqmp-common-v2026.1
endif
