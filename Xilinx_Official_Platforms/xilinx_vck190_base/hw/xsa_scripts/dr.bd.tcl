...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net psr_104mhz_peripheral_aresetn [get_bd_pins axi_intc_cascaded_1/s_axi_aresetn] [get_bd_pins axi_intc_parent/s_axi_aresetn] [get_bd_pins icn_ctrl_1/aresetn] [get_bd_pins icn_ctrl_2/aresetn] [get_bd_pins icn_ctrl_3/aresetn] [get_bd_pins icn_ctrl_4/aresetn] [get_bd_pins icn_ctrl_5/aresetn] [get_bd_pins psr_104mhz/peripheral_aresetn] [get_bd_pins dummy_slave_0/aresetn] [get_bd_pins dummy_slave_1/aresetn] [get_bd_pins dummy_slave_2/aresetn] [get_bd_pins dummy_slave_3/aresetn]
