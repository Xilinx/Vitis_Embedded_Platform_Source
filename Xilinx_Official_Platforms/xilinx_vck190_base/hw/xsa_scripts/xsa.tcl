...
set_property top xilinx_vck190_base_wrapper [current_fileset] 

# Ensure that your top of synthesis module is also set as top for simulation
set_property top xilinx_vck190_base_wrapper [get_filesets sim_1]
...
set_property top xilinx_vck190_base_wrapper_sim_wrapper [get_filesets sim_1]
import_files -fileset sim_1 -norecurse ./xilinx_vck190_base/xilinx_vck190_base.srcs/sources_1/common/hdl/xilinx_vck190_base_wrapper_sim_wrapper.v
update_compile_order -fileset sim_1
