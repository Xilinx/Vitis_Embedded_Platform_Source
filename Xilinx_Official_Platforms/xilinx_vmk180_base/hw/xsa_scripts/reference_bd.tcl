...
if { $list_projs eq "" } {
   ...
   set_property BOARD_PART xilinx.com:vmk180:part0:3.3 [current_project]
}
...
proc create_hier_cell_axi_smc_vip_hier { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wizard_0_clk_out3  [get_bd_pins aclk] \
  ...
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn  [get_bd_pins aresetn] \
...
{PMC_MIO 26 .. 36}}} \
  ...
  connect_bd_net -net clk_wizard_0_clk_out6  [get_bd_pins clk_wizard_0/clk_out6] \
  [get_bd_pins proc_sys_reset_5/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_clk_out7  [get_bd_pins clk_wizard_0/clk_out7] \
  ...
  set_property PFM.CLOCK {clk_out1 {id "1" is_default "false" proc_sys_reset "/proc_sys_reset_0" status "fixed" freq_hz "100000000"} clk_out2 {id "0" is_default "false" proc_sys_reset "/proc_sys_reset_1" status "fixed" freq_hz "150000000"} clk_out3 {id "2" is_default "true" proc_sys_reset "/proc_sys_reset_2" status "fixed" freq_hz "300000000"} clk_out4 {id "3" is_default "false" proc_sys_reset "/proc_sys_reset_3" status "fixed" freq_hz "75000000"} clk_out5 {id "4" is_default "false" proc_sys_reset "/proc_sys_reset_4" status "fixed" freq_hz "200000000"} clk_out6 {id "5" is_default "false" proc_sys_reset "/proc_sys_reset_5" status "fixed" freq_hz "400000000"} clk_out7 {id "6" is_default "false" proc_sys_reset "/proc_sys_reset_6" status "fixed" freq_hz "600000000"}} [get_bd_cells /clk_wizard_0]
