...
The hardware configurations are sourced from [Versal DFX Extensible Embedded Platform](https://github.com/Xilinx/XilinxCEDStore/tree/2026.1/ced/Xilinx/IPI/versal_dfx) Vivado Customizable Example Design (CED).

### General Information

| Type              | Value                           |
| ----------------- | ---------------------------     |
| Release Version   | xilinx_vck190_base_dfx_202610_1 |
...
Once the Vitis platform build completes, you can use the [Vitis Template](https://github.com/Xilinx/vitis_templates/) to build the **aie_dfx_design** application to test this platform. 
